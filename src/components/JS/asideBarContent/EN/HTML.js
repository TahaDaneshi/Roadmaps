const HTMLRoadmapEN = {
  ...
  freeResources: {
    roadmaps: [{ text: 'Visit the Dedicated HTML Roadmap', link: '#' }],
    courses: [{ text: 'Responsive Web Design Certification - Co-Learn HTML & CSS with guided projects', link: '#' }],
    videos: [{ text: 'HTML Full course for Beginners', link: '#' }, { text: 'HTML Full course - Build a Website Tutorial', link: '#' }],
    feeds: [{ text: 'Explore top posts about HTML', link: '#' }],
  }
};